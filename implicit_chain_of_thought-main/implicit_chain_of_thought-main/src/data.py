...
class CoTDataset(Dataset):
    def __init__(self, tokenizer, file_path, max_length):
        ...
        # Extract 'src' and 'tgt' lines from the JSON data
        src_lines = [item['src'] for item in data]
        tgt_lines = [item['tgt'] for item in data]
        ...
        for src, tgt in zip(src_lines, tgt_lines):
            ...
            # Modify sentences based on CoT and other formatting
